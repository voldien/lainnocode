...
from regression import logisticGradient, linear, extendMatrix, multiLogisticFit, multiLogisticPredict, logicError
from statistics import sigmoid, softmax, normalizeFeature
